...
[![CircleCI](https://circleci.com/gh/The-Aether-Team/Example-Mod/tree/1.19.4-develop.svg?style=shield)](https://app.circleci.com/pipelines/github/The-Aether-Team/Example-mod?branch=1.19.4-develop)
### Release builds
Example Mod has relatively stable beta builds available for release for 1.19.4 on [Modrinth](https://modrinth.com/mod/examplemod) and [CurseForge](https://www.curseforge.com/minecraft/mc-mods/examplemod). A full 1.0.0 release will be coming soon.
...
[![Code license (LGPL v3.0)](https://img.shields.io/badge/code%20license-LGPL%20v3.0-green.svg?style=flat-square)](https://github.com/The-Aether-Team/Example-Mod/blob/1.19.4-develop/LICENSE.txt)
...
All of our code contribution credits can be found [here](https://github.com/The-Aether-Team/Example-Mod/blob/1.19.4-develop/docs/CREDITS.txt). If you contributed to the project and do not see your name, please contact us.
