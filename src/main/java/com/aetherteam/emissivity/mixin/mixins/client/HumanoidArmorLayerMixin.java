...
public class HumanoidArmorLayerMixin<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> {
    ...
    private void render(HumanoidArmorLayer instance, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, A model, int color, ResourceLocation texture, Operation<Void> original) {
